...
Once the `conda-forge` channel has been enabled, `nvidia-ml` can be installed with:

```
conda install nvidia-ml
```

It is possible to list all of the versions of `nvidia-ml` available on your platform with:
